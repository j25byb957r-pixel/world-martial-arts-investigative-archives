const entries = [
  ...
  {title:'Three Forward / Three Back',category:'Movement Concepts',status:'working',url:'research/three-forward-three-back.html',summary:'Historical inquiry into early forward-and-backward Sanchin training, three-step claims, frontal organization, and Fujian San Zhan comparisons.',tags:['forward/backward','three steps','Sanchin','San Zhan','Wakayama','Fujian']},
