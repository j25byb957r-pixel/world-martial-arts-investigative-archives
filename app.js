const entries = [
  {title:'Sanchin / Sam Chien',category:'Forms & Kata',status:'comparative',url:'research/sanchin-sam-chien.html',summary:'Comparative research workspace for Sanchin traditions, Southern Chinese Sam Chien/San Zhan material, stepping, breath, structure, and transmission claims.',tags:['Sanchin','Sam Chien','San Zhan','breath','structure']},
